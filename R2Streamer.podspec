Pod::Spec.new do |s|
 ...
 s.description  = <<-DESC
                  ...
                  DESC
 s.homepage         = "https://github.com/codetoart/r2-streamer-swift.git"
 s.license          = 'BSD'
 s.author           = { "Varun Mehta" => "varun@mobisys.in" }
 s.source           = { :git => "https://github.com/codetoart/r2-streamer-swift.git" }
